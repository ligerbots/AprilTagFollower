...
public class AprilTagFinder extends Command {
    ...
    public void init() {
        Thread visionThread = new Thread(this::apriltagVisionThreadProc);
    ...
    void apriltagVisionThreadProc() {
        ...
        PositionCorrection positionCorrection = new PositionCorrection(m_DriveTrain);
        ...
        while (!Thread.interrupted()) {
            ...
            for (AprilTagDetection detection : detections) {
                ...
                tags.stream().filter(l -> l.longValue() == 1).findFirst().ifPresent(l -> positionCorrection.doRequiredMovement(pose));
            }
